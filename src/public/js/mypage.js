const searchAreaSelect = document.querySelector('.search-box__area');
const searchGenreSelect = document.querySelector('.search-box__genre');
const searchNameInput = document.querySelector('.search-box__name');
